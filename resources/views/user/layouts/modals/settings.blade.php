<div class="modal fade show" id="SettingsModal" aria-modal="true" role="dialog" data-bs-backdrop="static" data-bs-modal-backdrop-opacity="0.9">
                    ...
                    <div class="col-xl-12">
                        <div class="text-center">
                            <a href="#" class="text-center">
                                <i class="fas fa-times-circle fa-3x text-secondary" data-bs-dismiss="modal"></i>
                            </a>
                        </div>
                    </div>
                </div>
